...
export type FlavourKey = "ichigo" | "matcha" | "cocoa" | "vanilla" | "butter" | "hojicha" | "sakura";

const FLAVOURS: Record<FlavourKey, { label: string; fg: string; bg: string; dot: string }> = {
...
export interface FlavourTagProps extends React.HTMLAttributes<HTMLSpanElement> {
  flavour?: FlavourKey;
  onPhoto?: boolean;
}

export function FlavourTag({ flavour = "sakura", children, onPhoto = false, style, ...rest }: FlavourTagProps) {
